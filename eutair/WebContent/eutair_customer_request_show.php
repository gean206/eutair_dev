...
<body>
			...
			<div class="row">
				<div class="col-md-12 col-lg-8">
					<div class="title-single-box">
						<h1 class="title-single">Request</h1>
					</div>
				</div>
	...
	<!--/ Intro Single End /-->
	<!--/ service Single Star /-->
	<section class="color-background-custom">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-8">
					<div class="title-single-box">
						<h1 class="title-single">Customer Request</h1>
					</div>
				</div>
				<div class="col-md-12">
					<table
			...
			<div class="row">
				<div class="col-md-12 col-lg-8">
					<div class="title-single-box">
						<h1 class="title-single">Service Request</h1>
					</div>
				</div>
				<div class="col-md-12">
					<table
